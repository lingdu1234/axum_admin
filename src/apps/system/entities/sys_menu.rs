...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::Path => ColumnType::String(Some(255u32)).def().unique(),
            Self::MenuName => ColumnType::String(Some(255u32)).def(),
            Self::Icon => ColumnType::String(Some(255u32)).def(),
            ...
            Self::Perms => ColumnType::String(Some(255u32)).def(),
            Self::Component => ColumnType::String(Some(255u32)).def(),
            ...
            Self::IsDataScope => ColumnType::Char(Some(3u32)).def(),
