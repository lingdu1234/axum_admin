...
async fn sys_menu_init(txn: &DatabaseTransaction) {
    let sys_menus: Vec<SysMenuActiveModel> = vec![
        ...
        SysMenuActiveModel {
            ...
            status: Set("1".to_string()),
            perms: Set("system:menu:list".to_string()),
        ...
        SysMenuActiveModel {
            ...
            status: Set("1".to_string()),
            perms: Set("system:dict:list".to_string()),
        ...
        SysMenuActiveModel {
            ...
            status: Set("1".to_string()),
            perms: Set("system:user:list".to_string()),
        ...
        SysMenuActiveModel {
            ...
            status: Set("1".to_string()),
            perms: Set("system:dept:list".to_string()),
        ...
        SysMenuActiveModel {
            ...
            status: Set("1".to_string()),
            perms: Set("system:post:list".to_string()),
        ...
        SysMenuActiveModel {
            ...
            status: Set("1".to_string()),
            perms: Set("system:role:list".to_string()),
